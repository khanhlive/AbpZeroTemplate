...
using Hitechsoft.CRM.Authorization.Users.Profile.Dto;
using Hitechsoft.CRM.Commands;
using Hitechsoft.CRM.Core.Threading;
using Hitechsoft.CRM.Models.NavigationMenu;
using Hitechsoft.CRM.Services.Navigation;
...
using Hitechsoft.CRM.ApiClient;
using Hitechsoft.CRM.Controls;
using Hitechsoft.CRM.Dto;
using Hitechsoft.CRM.Extensions;
using Hitechsoft.CRM.Localization;
using Hitechsoft.CRM.UI;
using Hitechsoft.CRM.UI.Assets;
using Hitechsoft.CRM.Views;
using DependencyResolver = Hitechsoft.CRM.Core.Dependency.DependencyResolver;
