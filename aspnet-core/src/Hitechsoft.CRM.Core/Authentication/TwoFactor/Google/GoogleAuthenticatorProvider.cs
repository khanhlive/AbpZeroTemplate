...
namespace Hitechsoft.CRM.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : CRMServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Hitechsoft.CRM", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
