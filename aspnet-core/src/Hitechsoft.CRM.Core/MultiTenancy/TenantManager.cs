...
using Hitechsoft.CRM.MultiTenancy.Demo;
...
namespace Hitechsoft.CRM.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(CRMConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
