...
using Hitechsoft.CRM.Authorization.Ldap;
...
using Hitechsoft.CRM.DashboardCustomization.Definitions;
using Hitechsoft.CRM.Debugging;
using Hitechsoft.CRM.DynamicEntityProperties;
using Hitechsoft.CRM.Features;
using Hitechsoft.CRM.Friendships;
using Hitechsoft.CRM.Friendships.Cache;
using Hitechsoft.CRM.Localization;
using Hitechsoft.CRM.MultiTenancy;
using Hitechsoft.CRM.Net.Emailing;
using Hitechsoft.CRM.Notifications;
using Hitechsoft.CRM.WebHooks;
