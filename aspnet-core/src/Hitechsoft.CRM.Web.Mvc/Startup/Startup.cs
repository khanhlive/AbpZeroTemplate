...
using Hitechsoft.CRM.Web.Chat.SignalR;
using Hitechsoft.CRM.Web.Common;
using Hitechsoft.CRM.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Hitechsoft.CRM.Web.IdentityServer;
using Hitechsoft.CRM.Web.Swagger;
using Stripe;
...
using Hitechsoft.CRM.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;

namespace Hitechsoft.CRM.Web.Startup
{
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                app.UseSwaggerUI(options =>
                {
                    ...
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Hitechsoft.CRM.Web.wwwroot.swagger.ui.index.html");
